...
* The following dependency is not known to work with Spring Native: 'Spring Integration'. As a result, your application may not work as expected.
...
```
$ docker run --rm zip-and-graal-integration-example:0.0.1-SNAPSHOT
```
...
```
$ target/zip-and-graal-integration-example
```
